...
const LeftBanner = ({ displayAfterClick }) => {
  ...
  return (
    <div className="h-[calc(100vh-2rem)] my-[2rem] w-64 bg-black max1050:bg-transparent  rounded-3xl  flex flex-col overflow-auto max1050:h-auto max1050:w-screen max1050:fixed max1050:bottom-[-3rem] max1050:left-0 max1050:items-center max1050:z-30 ">
