...
const LeftBanner = ({ displayAfterClick }) => {
  ...
  return (
    <div className="h-[calc(100vh-3rem)] w-64 bg-black overflow-auto max1050:bg-transparent  rounded-3xl  flex flex-col  max1050:h-auto max1050:w-screen max1050:fixed max1050:bottom-2 max1050:left-0 max1050:items-center max1050:z-30">
      ...
      <div className="bg-[#d9d9d944] max1050:bg-black w-[100%] h-[100%] rounded-r-[7rem] rounded-b-none flex flex-col items-center justify-between py-12 max1050:p-0  max1050:max-w-[20rem] max1050:rounded-[6rem] max536:w-[90vw]">
        ...
        <div className="w-[80%] bg-[#d9d9d9b7] h-20 rounded-3xl flex flex-col justify-center items-center max1050:hidden text-[0.9rem] mt-[3rem]">
